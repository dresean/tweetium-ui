// todo add react-cookie and withCookies to export default
...
class Register extends Component {
    ...
    checkPassword = () => {
        if(this.state.password1 === this.state.password2) {
            return this.setState({password: this.state.password2})
    ...
    // todo finish the below function to check username input onBlur
    usernameValid = text => {
